...
void underwaterNavigation() {

  H[1][1] = cos(headingDegrees);  H[1][2] = -sin(headingDegrees);   H[1][3] = 0;    //rotation matrix for rotating around z axis
  H[2][1] = sin(headingDegrees);  H[2][2] = cos(headingDegrees);    H[2][3] = 0;
  H[3][1] = 0;                    H[3][2] = 0   ;                   H[3][3] = 1;

  Matrix.Multiply((mtx_type*) H, (mtx_type*) p, 3, 3, 1, (mtx_type*) pr);
  
  changeLat = pr[1]/111000;   //length of a degree of arc of latatude and longitude is about 111000 meters
  changeLong = pr[2]/111000;
